...
class TestBorg(object):
    ...
    def test_peer_state_borg(self):
        ...
        peer_borg2.change_node_type = wrapper
        loop.run_until_complete(peer_borg2.change_node_type('citizen2'))
        loop.close()
